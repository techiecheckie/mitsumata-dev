...
init -1 python hide:
    ...
    # XXX: derived from the Mitsumata whack a mole background size.
    config.screen_width = 635
    config.screen_height = 590
...
python early:
    config.save_directory = "minigame_sandbox-1317588827"
