...
label Scene33:
    ...
    $hide_main_ui()
label battle1:        
  $battle("Riku", "Demon thug", 1, "bg dgro")
...
label Scene53:
    ...
    ro  "Anyway...I just thought I'd ask because you seemed a bit shaken."
