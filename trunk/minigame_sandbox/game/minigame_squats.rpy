    ...
    class Squats( Minigame ):
        ...
        def render( self, blitter ):
            ...
            if self.state == SQUATS_GAME_STATE_BEGIN:
                ...
                self.bar["renderer"].render( blitter, world_transform )
                for bar_segment in self.bar_segments:
                    bar_segment["renderer"].render( blitter, world_transform )
                self.marker["renderer"].render( blitter, world_transform )
